...
class DepartmentService {
    ...
    private func isVaildData(data: Data) -> NetworkResult<Any> {
        ...
        guard let decodedData = try? decoder.decode(DepartmentResponse.self, from: data) else { return .pathErr }
