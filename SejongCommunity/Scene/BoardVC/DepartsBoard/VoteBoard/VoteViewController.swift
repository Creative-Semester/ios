...
//                           let imageNames = images["imageName"] as? String,
                        ...
                        {
                            let post = VotePost(boardId: boardId, title: title, content: content, images: VotePost.Images(imageName: "", imageUrl: ""), day: day, page: page)
                            posts.append(post)
                        }
                    }
