...
//MARK: - Set_TableView
extension MyCommentDetailViewController{
    func calculateCommentCellHeight(for comment: MyComment) -> CGFloat {
        // 여기에서 각 댓글 셀의 높이를 계산.
                ...
                if let result = json?["result"] as? [String: Any],
                   ...
                   let comments = result["commentList"] as? [[String: Any]] {
                    ...
                    for comment in comments {
                        ...
                        {
                            let post = MyComment(day: day, commentId: commentId, comment: commentText, commentIsMine: isMine)
                            posts.append(post)
                        }
                    }
                ...
                DispatchQueue.main.async {
                    ...
                    let CancelController = UIAlertAction(title: "확인", style: .default) { (_) in
                        ...
                        if let navigationController = self.navigationController {
                            ...
                            let openBoardViewController = MyCommentViewController()
